  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center pt-24 pb-16 lg:pt-32">
      ...
      <div className="absolute inset-0 -z-0 overflow-hidden pointer-events-none">
        <motion.div 
            style={{ y: y1, x: mousePosition.x * -20, rotate: -10 }} 
            className="absolute top-[10%] left-[5%] w-48 h-64 md:w-64 md:h-80 opacity-20 hover:opacity-40 transition-opacity duration-500"
        >
             <Image 
                src="/images/code-placeholder.svg" 
                alt="Coding" 
                fill 
