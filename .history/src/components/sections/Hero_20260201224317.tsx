          ...
          <div className="space-y-8 z-10">
            ...
            >
              <a
                ...
                className="rounded-full bg-sky-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-sky-500/20 transition-all hover:bg-sky-400 hover:scale-105 active:scale-95"
              >
                Download Resume
              </a>
              <a
                href="#contact"
                className="rounded-full border border-slate-700 bg-slate-900/50 px-6 py-3 text-sm font-semibold text-slate-300 transition-all hover:border-slate-500 hover:text-white hover:bg-slate-800"
              >
                Contact Me
              </a>
            </motion.div>
